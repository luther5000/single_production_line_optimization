...
int main() {
    std::string endereco = "instancias/n60A.txt";
    instancia_problema instancia_problema(endereco);

    instancia_problema.algoritmo_guloso();
    instancia_problema.calcula_solucao();

    cout << instancia_problema.getsolucao_valor();
}
